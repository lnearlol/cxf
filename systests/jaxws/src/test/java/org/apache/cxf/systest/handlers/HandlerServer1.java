...
public class HandlerServer1 extends AbstractBusTestServerBase {
    public static final String PORT1 = TestUtil.getPortNumber(HandlerServer1.class, 1);
    public static final String PORT2 = TestUtil.getPortNumber(HandlerServer1.class, 2);
